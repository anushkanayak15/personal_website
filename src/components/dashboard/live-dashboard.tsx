...
export function LiveDashboard() {
  ...
  return (
    <aside className="hidden shrink-0 2xl:block">
      <div className="sticky top-20 w-64 space-y-5 rounded-xl border border-border bg-card/60 p-5 backdrop-blur-sm">
        ...
        <Field label="Now Exploring">
          <span className="text-sm text-foreground">RAG & model evaluation</span>
        </Field>
        ...
        <Field label="Reading">
          <span className="text-sm text-foreground">Papers on RAG evaluation & fairness in ML</span>
        </Field>

        <Field label="Learning">
          <span className="text-sm text-foreground">Distributed systems at production scale</span>
        </Field>
